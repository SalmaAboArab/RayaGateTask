    ...
    <Modal show={deleteShow} onHide={deleteHandleClose} centered={true}>
        ...
        <Modal.Body>
          <div className='my-3 mx-5'>
            ...
            <p>are you sure you want to delete this post ? if you are sure just click on delete it</p>
            </div>
            <div className="text-end pt-3 border-top">
            <button className='btn btn-outline-danger fw-bold  bg-danger text-white' onClick={onSubmitDelete}> {` Delete this post`}</button>
            </div>
          </div>
        </Modal.Body>
